  ...
  const router = {
   ...
   return(
      <div style={{marginTop: "3em"}}>
         ...
         <div style={{display: "flex", justifyContent: "space-around", alignItems: "center", marginLeft: "5em", marginRight: "5em",marginBottom: "2em"}}>
            <button></button>
            <button></button>
            <button></button>
            <button></button>
         ...
         <div>
            ...
            <div style={{display: "flex", flexDirection: "column",margin: "1em", marginLeft: "5em", marginRight: "5em"}}>
               <a style={{fontFamily: "subMain", color: "white", cursor: "pointer"}} href='https://github.com/sebgorgone/Cloud-Log' title="cloudlog repo" target='none'>Cloudlog repo</a>
